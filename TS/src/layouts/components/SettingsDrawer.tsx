...
const SettingsDrawer = () => {
  ...
  const themes = [
    { id: 'default', name: 'Default', gradient: 'linear-gradient(135deg, #FF6A00, #F6A2D5, #4C91BF, #7A8B92, #AB7C9A)' },
    {
      id: 'nebula',
      name: 'Nebula',
      gradient: 'linear-gradient(135deg, #2a7dbf, #2a9d8f, #766cbc, #f4a261, #e76f51)',
    },
    { id: 'olive', name: 'Olive', gradient: 'linear-gradient(135deg, #556B2F, #6B8E23, #8B9A3D, #A9B83E, #BDB76B)' },
    { id: 'solar', name: 'Solar', gradient: 'linear-gradient(135deg, #FF8C00, #FFD700, #FF4500, #F1C40F, #F39C12)' },
    {
      id: 'lunar',
      name: 'Lunar',
    ...
    { id: 'earth', name: 'Earth', gradient: 'linear-gradient(135deg, #2198f3, #3173a5, #3f6888, #618d48, #52bf11)' },
    { id: 'flare', name: 'Flare', gradient: 'linear-gradient(135deg, #FF4500, #FF6347, #F44336, #D32F2F, #B71C1C)' },
    {
      id: 'storm',
      name: 'Storm',
            ...
            <div className="clickable-boxes">
              {themes.map((theme, index) => (
                <React.Fragment key={theme.id}>
                  ...
                  />
                  <label htmlFor={`option${index}`} data-prefix={theme.name} style={{ background: theme.gradient }}></label>
                </React.Fragment>
              ))}
            </div>
          </div>
