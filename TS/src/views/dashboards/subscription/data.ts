...
export const getSubscriptionChartOptions = (): ApexOptions => ({
  series: [
    { name: 'Visits', type: 'area' as const, data: [23686, 30820, 59622, 146465, 78160, 79520, 36148, 48721, 158303, 155174, 104830, 86895] },
    { name: 'Subscriptions', type: 'line' as const, data: [1545, 1350, 1270, 1830, 1955, 1865, 2034, 2544, 1956, 2211, 1540, 1670] },
  ],
  chart: {
    height: 335,
    type: 'line',
