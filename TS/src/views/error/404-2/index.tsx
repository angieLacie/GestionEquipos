          ...
          <Row className="justify-content-center">
            <Col xs={11} md={8} lg={6} xl={4}>
              <div className="login-card p-4 p-md-6 bg-dark bg-opacity-50 translucent-dark rounded-4 text-center">
                <div className="mb-5 mx-auto" style={{ maxWidth: 100 }}>
                ...
                <p className="text-white opacity-50 mb-4">Sorry, the page you are looking for doesn’t exist or has been moved.</p>
                ...
                <div className="opacity-50 text-white small">If you believe this is a mistake, please let us know.</div>
              </div>
            </Col>
          </Row>
        </Container>
