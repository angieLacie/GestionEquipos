...
const TableWithCheckboxSelect = () => {
  const columns = [
    {
      ...
      header: ({ table }: { table: TableType<UserType> }) => (
        <input
          type="checkbox"
          className="form-check-input cursor-pointer form-check-input-light fs-14"
      ...
      cell: ({ row }: { row: TableRow<UserType> }) => (
        <input
          type="checkbox"
          className="form-check-input form-check-input-light cursor-pointer fs-14"
  ...
  const table = useReactTable({
    data,
    columns,
    state: { globalFilter, rowSelection: selectedRowIds, pagination },
  ...
  return (
    <div className="content-wrapper">
      <PageBreadcrumb
        title={'TanStack Table with Checkbox Select'}
